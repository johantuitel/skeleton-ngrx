import { createSelectItemActions } from 'src/features/http/create.select.item.actions';
...
export const [selectEmployee, selectEmployeeSuccess, selectEmployeeClear] = createSelectItemActions<Employee>(ACTION_PREFIX);
